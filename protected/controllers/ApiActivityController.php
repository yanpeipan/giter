...
class ApiActivityController extends ApiBaseNewController
{ 
    /**
     * 请求的api类型
     * @var string
	...
	public function getApiParamsByMethod(){
		$apiParams = array(
            //puti
            'api.tuzi.verifyTcode'=>array(
                'import'  => array('ext.api.*','ext.api.puti.ActivityApi'),
                'class'  => 'ActivityApi',
                'method' => 'verify',
                'field'=>'uid,tcode',
            ),
    ...
    public function runModuleApi(){
		...
		$dir_name = "api_".$version;
		
		//加载模块入口类文件
		$module = "Api_".$version."Module";
    	Yii::import('application.modules.'.$dir_name.'.'.$module);
