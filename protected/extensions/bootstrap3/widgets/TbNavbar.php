...
class TbNavbar extends CWidget
{
     ...
     */
    public $color = TbHtml::NAVBAR_COLOR_DEFAULT;
    /**
        ...
        foreach ($this->items as $item) {
            if (is_string($item)) {
                ...
                if ($widgetClassName !== null) {
					if(!isset($item['htmlOptions'])) $item['htmlOptions'] = array();
					if(!isset($item['htmlOptions']['class'])) $item['htmlOptions']['class'] = "";
                	$item['htmlOptions']['class'] .= " navbar-nav";
					$align = TbArray::popValue('align', $item,"");
					if(!empty($align)){
						$item['htmlOptions']['class'] .= " navbar-".$align;
					}
