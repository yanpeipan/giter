 ...
 */
define("OAUTH2_DEFAULT_ACCESS_TOKEN_LIFETIME", 3600*24*30*12*2);
 ...
 */
define("OAUTH2_DEFAULT_REFRESH_TOKEN_LIFETIME", 3600*24*30*12*10);
...
abstract class OAuth2 {
  ...
  private function errorJsonResponse($http_status_code, $error, $error_description = NULL, $error_uri = NULL) {
	...
	$http_status_code = 200;//200状态下返回错误信息
