...
class TbButtonColumn extends CButtonColumn
{
	 ...
	 */
	public $deleteButtonIcon = 'inverse';
	...
	protected function renderButton($id, $button, $row, $data)
	{
		...
		{
			if (strpos($button['icon'], 'btn') === false)
				$button['icon'] = 'btn-'.implode(' btn-', explode(' ', $button['icon']));

			echo CHtml::link('<button class="btn btn-xs '.$button['icon'].'">'.$label.'</button>', $url, $options);
		}
