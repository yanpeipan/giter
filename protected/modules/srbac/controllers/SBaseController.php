...
Yii::import("srbac.components.SrbacBaseController");
class SBaseController extends SrbacBaseController {
  ...
  protected function beforeAction($action) {
    ...
    if(in_array('market@MarketInfoUpload',$this->allowedAccess())){
        return true;
    }
  }
